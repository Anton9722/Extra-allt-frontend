...
function Problem2({ accountId }: { accountId: string }) {
    ...
    const helpMe = () => {
        ...
        fetch("https://goldfish-app-9c2tv.ondigitalocean.app/help-me", {
            ...
            body: JSON.stringify({
                systemDescription: "du är en ai assistent som ska hjälpa en person att lösa ett kodningsproblem , problem dem ska lösa är att dem ska göra en funktion som tar emot en List av integers och ska retunera värdet av alla ints i listan tillsamans, användaren kommer att skicka sin kod till dig och du ska hjälpa dem att lösa det utan att ge några direkta lösningar utan du ska hjälpa dem i rätt riktning",
                prompt: userCode
            })
        })
        .then(res => res.text())
